...
Customize colors for the analyses. Edit the values below to use your preferred colors:
...
```{r grave-type-plot, fig.width=14, fig.height=5}
...
```{r burial-plot, fig.width=14, fig.height=5}
...
```{r dv-by-type-plot, fig.width=14, fig.height=5}
...
```{r dv-by-burial-plot, fig.width=14, fig.height=5}
